...
export const Contact = ({ contact }) => {
  ...
  return (
    <div className={cot.contact_top} ref={contact}>
                  ...
                  <div className={cot.one}>
                    ...
                    <div className={cot.inform}>
                      ...
                      <Button
                        ...
                        leftIcon={
                          <MdEmail color="rgb(255, 255, 255)" size="20px" />
                        }
                      >
                      ...
                      <Button
                        ...
                        leftIcon={
                          <MdPhone color="rgb(255, 255, 255)" size="20px" />
                        }
                      >
                        +91-6397310463
                      </Button>
                          ...
                          <FormControl id="name">
                            ...
                            <InputGroup borderColor="rgb(182,116,41)">
                              <InputLeftElement
                                pointerEvents="none"
                                children={
                                  <MdOutlineEmail color="rgb(182,116,41)" />
                                }
                              />
                              <Input
                                type="email"
      ...
      <h2 className={cot.last}>2023 Tushit Saxena</h2>
    </div>
  );
};
